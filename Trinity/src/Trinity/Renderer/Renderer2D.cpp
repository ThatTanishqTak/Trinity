...
namespace Trinity
{
	...
	void Renderer2D::Init()
	{
		...
		s_Data.CircleVertexBuffer->SetLayout({
			{ ShaderDataType::Float3,   std::string("a_WorldPosition")  },
			{ ShaderDataType::Float3,   std::string("a_LocalPosition")  },
			{ ShaderDataType::Float4,   std::string("a_Color")          },
			{ ShaderDataType::Float,    std::string("a_Thickness")      },
			{ ShaderDataType::Float,    std::string("a_Fade")           },
			{ ShaderDataType::Int,      std::string("a_EntityID")       }
		});

		s_Data.CircleVertexArray->AddVertexBuffer(s_Data.CircleVertexBuffer);
		s_Data.CircleVertexArray->SetIndexBuffer(quadIB); // Intentional
