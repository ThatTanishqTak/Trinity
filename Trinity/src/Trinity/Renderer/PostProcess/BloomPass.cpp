...
namespace Trinity
{
    ...
    {
        m_VertexSpv = ShaderCompiler::CompileToSpv("Resources/TrinityForge/DefaultAssets/Shaders/Bloom.vert");
        m_FragmentSpv = ShaderCompiler::CompileToSpv("Resources/TrinityForge/DefaultAssets/Shaders/Bloom.frag");
