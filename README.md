...
## Screenshots
![](C:\Users\tanis\Pictures\Screenshots\Screenshot.png "Forge")
...
After the setup is complete, open the `Forge.sln` file, build the solution, and navigate to the `bin/(Configuration)/Forge/` directory. Run the `.exe` file there.
